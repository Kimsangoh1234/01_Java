...
(자료)형변환
	...
	이동하기 때문에 강제로 넣어줘야함(강제로 넣을 경우 데이터 손실 발생 가능성 있음)
	...
	메서드 호출을 통한 형변환
		...
		Double.parseInt(변환할 String 변수);
		Byte.parseInt(변환할 String 변수);
		short.parseInt(변환할 String 변수);
